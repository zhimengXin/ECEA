...
from ecea.data import *
from ecea.modeling import build_model
from ecea.engine.hooks import EvalHookECEA
from ecea.checkpoint import DetectionCheckpointer
from ecea.solver import build_lr_scheduler, build_optimizer
from ecea.evaluation import DatasetEvaluator, inference_on_dataset, print_csv_format, verify_results
from ecea.dataloader import MetadataCatalog, build_detection_test_loader, build_detection_train_loader
...
def default_argument_parser():
    """
    Create a parser with some common arguments used by ECEA users.

    Returns:
        argparse.ArgumentParser:
    """
    parser = argparse.ArgumentParser(description="ECEA Training")
...
def default_setup(cfg, args):
    ...
    setup_logger(output_dir, distributed_rank=rank, name="evea")
...
class DefaultTrainer(SimpleTrainer):
    ...
    def build_model(cls, cfg):
        ...
        It now calls :func:`ecea.modeling.build_model`.
    ...
    def build_optimizer(cls, cfg, model):
        ...
        It now calls :func:`ecea.solver.build_optimizer`.
    ...
    def build_lr_scheduler(cls, cfg, optimizer):
        """
        It now calls :func:`ecea.solver.build_lr_scheduler`.
    ...
    def build_train_loader(cls, cfg):
        ...
        It now calls :func:`ecea.data.build_detection_train_loader`.
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        It now calls :func:`ecea.data.build_detection_test_loader`.
        Overwrite it if you'd like a different data loader.
        """
